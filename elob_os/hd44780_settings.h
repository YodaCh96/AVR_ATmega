...
#endif
#define LCD_DB4_PORT             PORTL       // If using 4 bit mode, you must configure DB4-DB7
...
#define LCD_RW_PORT              PORTL       // Port for RW line (ONLY used if RW_LINE_IMPLEMENTED=1)
...
#define LCD_E_PIN                2           // Pin for E line
  ...
  #define LCD_E3_PORT            PORTL       // Port for E line
  #define LCD_E3_PIN             2           // Pin for E line
#endif
  ...
  #define LCD_E4_PORT            PORTL       // Port for E line
  #define LCD_E4_PIN             2           // Pin for E line
#endif
